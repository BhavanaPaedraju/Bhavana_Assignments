...
public class Q3 {
	...
	public static void main(String[] args) {
		...
		empl s = new empl(1,"thor","IT",1231);
		empl s1 = new empl(2,"giant","HR",21231);
		empl s2 = new empl(3,"kackie","food",51231);
		empl s4= new empl(4,"loki","IT",1123231);
		empl s5 = new empl(5,"giant","HR",241231);
		empl s6 = new empl(6,"jasminee","food",234234);
		emp.add(s);
		emp.add(s1);
		emp.add(s2);
		emp.add(s4);
